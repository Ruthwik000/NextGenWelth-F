            ...
            <Link href="/" className="inline-block mb-6">
              <div className="flex items-center gap-2">
                <Image
                  ...
                  className="w-8 h-8"
                />
                <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-cyan-300">NextGenWealth</span>
              </div>
            </Link>
            <p className="text-muted-foreground mb-8 max-w-md leading-relaxed">
              NextGenWealth is revolutionizing personal finance with AI-powered insights and intelligent wealth management for the next generation.
            </p>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex justify-center items-center">
            <p className="text-muted-foreground text-sm text-center">
              © 2025 NextGenWealth. Designed and developed by G. Ruthwik.
            </p>
          </div>
        </div>
      </div>
